...
public class ReplyingKafkaTemplateConfiguration {
    ...
    public ConcurrentMessageListenerContainer<String, String> repliesContainer(ConcurrentKafkaListenerContainerFactory<String, String> containerFactory) {
        ConcurrentMessageListenerContainer<String, String> container = containerFactory.createContainer("test.topic.replies");
        container.getContainerProperties().setGroupId("test.topic.replies.container.id");
        return container;
    }
}
